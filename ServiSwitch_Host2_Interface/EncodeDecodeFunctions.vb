...
Public Class EncodeDecodeFunctions
    ...
    Dim EncryptConnString As String
    ...
    Public Function Load_Config_Keys() As Byte
        ...
        EncryptConnString = NodeTemp.ItemOf(0).InnerText.ToString
    ...
    Public Function SetgetStringConnection() As String

        EncryptConnString = Decrypt(EncryptConnString)
        Return EncryptConnString
