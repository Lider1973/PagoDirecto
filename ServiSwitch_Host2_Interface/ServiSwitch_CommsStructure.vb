...
Public Class FixedStrucure
    ...
    Public Structure RequestInquiry
        ...
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=35)> Public SEGi_TargetName As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=10)> Public SEGi_Observation As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=13)> Public SEGi_SourceID As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=10)> Public SEGi_City As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=20)> Public SEGi_Reference As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=13)> Public SEGi_TargetID As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=6)> Public SEGi_Filler As String
    ...
    Public Structure ReplyInquiry
        ...
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=2)> Public SEGo_AcctType As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=18)> Public SEGo_AcctNumber As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=40)> Public SEGo_AcctName As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=8)> Public SEGo_MinPayment As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=8)> Public SEGo_TotPayment As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=8)> Public SEGo_LimitDate As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=10)> Public SEGo_TargetPhone As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=13)> Public SEGo_TargetID As String
    ...
    Public Structure RequestReversal
        ...
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=6)> Public SourceSeqNbr As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=4)> Public MessageSeqNbr As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=4)> Public TransactionCode As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=1)> Public TranCodeSign As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=6)> Public SourceDate As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=6)> Public SourceTime As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=10)> Public SourceAbaNbr As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=4)> Public SourceBranchNbr As String
    ...
    <StructLayout(LayoutKind.Sequential, CharSet:=CharSet.Unicode)> _
    Public Structure RequestReversal_C
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=2)> Public MessageType As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=4)> Public SourceFiNbr As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=5)> Public SourceTrmlNbr As String
        <MarshalAs(UnmanagedType.ByValTStr, SizeConst:=6)> Public SourceSeqNbr As String
