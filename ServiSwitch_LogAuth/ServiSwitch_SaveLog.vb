...
Module mod_SaveLog
    ...
    Private Sub SaveLog(ByVal BufferToSave As String)
        ...
        BufferToSave = GetDateTime() & " " & BufferToSave
    ...
    Public Sub SaveLogMain(ByVal BufferToSave As String)
        ...
        Try
            ...
            LogEvent.Set()
        Catch ex As Exception
            Show_Message_Console("LogQueue Exception: " & ex.Message, COLOR_OWNER1, COLOR_RED, 0, TRACE_LOW, 1)
        End Try
...
BeginWait:
        Try
            ...
            GoTo BeginWait
        Catch ex As Exception
            Show_Message_Console("SaveLog Exception: " & ex.Message, COLOR_OWNER1, COLOR_RED, 0, TRACE_LOW, 1)
        End Try
